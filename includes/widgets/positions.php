	...
	public function edit_content_markup( $value = '', $key = 'cacap-positions' ) {
		...
		if ( ! empty( $value ) && is_array( $value ) ) {
			...
			foreach ( $value as $position ) {
				...
				$markup .=     '<td>';
				$markup .=     '<input data-field-type="college" class="cacap-edit-input cacap-position-field-autocomplete cacap-position-field-college" name="' . esc_attr( $key ) . '[content][' . $counter . '][college]" id="' . esc_attr( $key ) . '_college" value="' . esc_attr( $current_college ) . '" />';
				$markup .=     '</td>';
				$markup .=   '</tr>';
				...
				$markup .=     '<td>';
				$markup .=     '<input data-field-type="department" class="cacap-edit-input cacap-position-field-autocomplete cacap-position-field-department" name="' . esc_attr( $key ) . '[content][' . $counter . '][department]" id="' . esc_attr( $key ) . '_department" value="' . esc_attr( $current_department ) . '" />';
				$markup .=     '</td>';
				$markup .=   '</tr>';
...
function cacap_positions_suggest_cb() {
	...
	if ( $field && $value ) {
		switch ( $field ) {
			case 'college' :
				$terms = get_terms( 'cacap_position_college', array(
					'name__like' => $value,
				) );
