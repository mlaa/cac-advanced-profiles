	...
	<div id="cacap-content">
		<?php if ( bp_is_user_profile_edit() ) : ?>
			...
			<div class="remodal" data-remodal-id="modal">
				...
				<p>The Portfolios profile system allows you to enter information about yourself and your career so that you might better connect with other users of the <em>Commons</em>.</p>
				<br>
